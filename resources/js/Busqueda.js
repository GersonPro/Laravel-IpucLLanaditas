  ...
  fetch('http://127.0.0.1:8000/buscar-membresia?search=' + searchString)
      ...
      .then(data => {
          ...
          data.forEach(member => {
              ...
              editCell.innerHTML = `<a href="#" class="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Edit</a>`;
